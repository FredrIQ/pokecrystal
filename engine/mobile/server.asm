...
PO_CMD_WONDERTRADE EQU $02
PO_CMD_SETINFO     EQU $03
PO_CMD_GETINFO     EQU $04
PO_CMD_LISTUSERS   EQU $05
PO_CMD_BATTLEUSER  EQU $06
PO_CMD_TRADEUSER   EQU $07
PO_CMD_GETBATTLE   EQU $08
PO_CMD_BATTLETURN  EQU $09
PO_CMD_TRADETURN   EQU $0a
PO_CMD_SETREPLY    EQU $0b

PO_SIGNAL_ERROR       EQU $81
PO_SIGNAL_ASKBATTLE   EQU $86
PO_SIGNAL_ASKTRADE    EQU $87

PO_STATUS_CLOSED      EQU $00

PO_REPLY_ACCEPT       EQU $00
PO_REPLY_REJECT       EQU $01
PO_REPLY_WAIT         EQU $02

PO_ERROR_OK           EQU $00 ; no error, but some functions return this
PO_ERROR_UNKNCMD      EQU $01
PO_ERROR_UNKNUSER     EQU $02
PO_ERROR_BADINFO      EQU $03
PO_ERROR_INCOMPATIBLE EQU $04
PO_ERROR_UNAUTHORIZED EQU $05
PO_ERROR_WITHANOTHER  EQU $06
...
; Returns c upon a signal with sent command in a, received in b.
	...
	xor a
	ld c, 1
	farcall2 ExchangeTCPData
	jr c, .disconnected
	jr z, .got_required_data
	farcall2 ForceContinueExchangeTCPData
	jr c, .disconnected
.got_required_data
	ld a, [wPO_Data]
	ld c, a
	push bc
	farcall2 ContinueExchangeTCPData
	pop bc
	jr c, .disconnected
	ld hl, wPO_Data + 1
	ld de, wPO_Data
